...
<?php get_header(); ?>
      ...
      <!-- Begin page content -->
      <div class="home-content container col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
        ...
        <!-- <div class="col-xs-10 col-xs-offset-1 col-md-12 col-md-offset-0">
	        <p class="test lead text-center"><i>In the quest for energy independence, VicNRG is the only real solution.</i></p>
        </div> -->
